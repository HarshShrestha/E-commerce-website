...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80h] border-t border-gray-300'>
      {/* ----------------Left Side --------------- */}
      <div className="flex flex-col gap-4 w-full sm:max-w-120">
        ...
        <div className="flex gap-3">
          <input type="number" placeholder='Phone' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>        </div>
      </div>  
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            ...
            <div onClick={()=>setMethod('razor')} className={`flex items-center gap-3 border border-gray-300 p-2 px-3 cursor-pointer`}>
